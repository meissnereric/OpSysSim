...
struct Statistics{
    ...
    void printForAnalysis(std::ostream & out){
        ...
        */
        ...
        out << averageResponseTime << std::endl;
...
{
public:
    static void clearSystem(typeOfReadySet, double);
    ...
    void initEQ(double cpus, double ios, double context, double mix, double freq);
